...
" alt="Foto" style="width:100%; height:100%; border-radius:50%; object-fit:cover;">
                        </div>
                        <div>
                            <h4 class="client-name"><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['servicio']->value['nombre'], ENT_QUOTES, 'UTF-8', true);?>
</h4>
                            <p class="client-nickname"><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['servicio']->value['nickname'], ENT_QUOTES, 'UTF-8', true);?>
</p>
                        </div>
                    </div>
                    <div class="client-info">
                        <div class="info-row">
                            ...
                            <span><strong>Especialidad:</strong> <?php echo htmlspecialchars($_smarty_tpl->tpl_vars['servicio']->value['especialidad'], ENT_QUOTES, 'UTF-8', true);?>
</span>
                        </div>
                        <div class="info-row">
                            <i class="fas fa-star info-icon" style="color: #f59e0b;"></i>
                            <span>
                                <strong>Calificación:</strong> <?php echo $_smarty_tpl->tpl_vars['servicio']->value['estrellas'];?>
 / 5
                            </span>
                        </div>
                    </div>
