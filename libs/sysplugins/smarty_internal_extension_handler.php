...
{
    protected $_codeFrame;      // Si no existe, añádela
    protected $getLiterals;     // Si no existe, añádela
    protected $addLiterals;     // Si no existe, añádela
    protected $setLiterals;     // Si no existe, añádela
    protected $getTemplateVars; // Si no existe, añádela
