<?php
/* Smarty version 3.1.39, created on 2025-05-10 02:56:35
  from '/var/www/html/rocio/rocio/templates/dashboard_servicios.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.39',
  'unifunc' => 'content_681ec06305ba21_42531749',
...
function content_681ec06305ba21_42531749 (Smarty_Internal_Template $_smarty_tpl) {
...
<head>
    ...
    <title><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['page_title']->value, ENT_QUOTES, 'ISO-8859-1', true);?>
</title>
...
?>
                <li>
                    <input type="checkbox" class="filtro-categoria" 
                           id="cat_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['categoria']->value['id'], ENT_QUOTES, 'ISO-8859-1', true);?>
" 
                           data-categoria="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['categoria']->value['id'], ENT_QUOTES, 'ISO-8859-1', true);?>
" 
                           <?php if ($_smarty_tpl->tpl_vars['categoria']->value['checked']) {?>checked<?php }?>>
                    <label for="cat_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['categoria']->value['id'], ENT_QUOTES, 'ISO-8859-1', true);?>
"><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['categoria']->value['nombre'], ENT_QUOTES, 'ISO-8859-1', true);?>
</label>
                </li>
                <?php
}
...
?>
                <li>
                    <input type="checkbox" class="filtro-disponibilidad" 
                           id="disp_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['disp']->value['id'], ENT_QUOTES, 'ISO-8859-1', true);?>
" 
                           data-dia="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['disp']->value['id'], ENT_QUOTES, 'ISO-8859-1', true);?>
"
                           <?php if ($_smarty_tpl->tpl_vars['disp']->value['checked']) {?>checked<?php }?>>
                    <label for="disp_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['disp']->value['id'], ENT_QUOTES, 'ISO-8859-1', true);?>
"><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['disp']->value['nombre'], ENT_QUOTES, 'ISO-8859-1', true);?>
</label>
                </li>
                <?php
}
...
?>
            <section id="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['servicio']->value['id'], ENT_QUOTES, 'ISO-8859-1', true);?>
" class="servicio" 
                     data-estrellas="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['servicio']->value['estrellas'], ENT_QUOTES, 'ISO-8859-1', true);?>
" 
                     data-precio="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['servicio']->value['precio'], ENT_QUOTES, 'ISO-8859-1', true);?>
" 
                     data-disponibilidad="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['servicio']->value['disponibilidad'], ENT_QUOTES, 'ISO-8859-1', true);?>
">
                <img src="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['servicio']->value['imagen'], ENT_QUOTES, 'ISO-8859-1', true);?>
" alt="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['servicio']->value['nombre'], ENT_QUOTES, 'ISO-8859-1', true);?>
">
                <div>
                    <h2><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['servicio']->value['nombre'], ENT_QUOTES, 'ISO-8859-1', true);?>
</h2>
                    <p><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['servicio']->value['descripcion'], ENT_QUOTES, 'ISO-8859-1', true);?>
</p>
                    <button onclick="mostrarDetalles('<?php echo strtr($_smarty_tpl->tpl_vars['servicio']->value['id'], array("\\" => "\\\\", "'" => "\\'", "\"" => "\\\"", "\r" => "\\r", "\n" => "\\n", "</" => "<\/" ));?>
')">Ver más</button>
                    <div id="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['servicio']->value['id'], ENT_QUOTES, 'ISO-8859-1', true);?>
-detalles" class="detalles">
                        <p><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['servicio']->value['detalles'], ENT_QUOTES, 'ISO-8859-1', true);?>
</p>
                    </div>
                </div>
            </section>
...
$_smarty_tpl->smarty->ext->_foreach->restore($_smarty_tpl, 1);?>
    ...
    <!-- Footer -->
    <footer>
        <p>&copy; <?php echo htmlspecialchars($_smarty_tpl->tpl_vars['current_year']->value, ENT_QUOTES, 'ISO-8859-1', true);?>
 <?php echo htmlspecialchars($_smarty_tpl->tpl_vars['company_name']->value, ENT_QUOTES, 'ISO-8859-1', true);?>
</p>
    </footer>
